...
@objc public enum MQTTAUTHReasonCode: UInt8 {
	case success = 0x00
	case continueAuthentication = 0x18
	case ReAuthenticate = 0x19
}

@objc public enum MQTTCONNACKReasonCode: UInt8 {
	case success = 0x00
...
@objc public enum MQTTDISCONNECTReasonCode: UInt8 {
...
@objc public enum MQTTPUBACKReasonCode: UInt8 {
	case success = 0x00
...
@objc public enum MQTTPUBCOMPReasonCode: UInt8 {
	case success = 0x00
	case packetIdentifierNotFound = 0x92
}

@objc public enum MQTTPUBRECReasonCode: UInt8 {
	case success = 0x00
	case noMatchingSubscribers = 0x10
	case unspecifiedError = 0x80
	case implementationSpecificError = 0x83
...
@objc public enum MQTTPUBRELReasonCode: UInt8 {
	case success = 0x00
	case packetIdentifierNotFound = 0x92
}

@objc public enum MQTTSUBACKReasonCode: UInt8 {
...
@objc public enum MQTTUNSUBACKReasonCode: UInt8 {
	case grantedQoS0 = 0x00
...
@objc public enum RetainHandlingOption: UInt8 {
