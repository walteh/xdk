...
extension xid.XID: CustomStringConvertible {
...
extension xid.XID: Equatable {
	public static func == (lhs: xid.XID, rhs: xid.XID) -> Bool {
		lhs.bytes == rhs.bytes
	}
}
